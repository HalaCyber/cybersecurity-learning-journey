...
**dirb:** Scans a website to discover hidden directories and pages by trying common URL names ( Any lines from the output that start with + are pages that have been found.)
